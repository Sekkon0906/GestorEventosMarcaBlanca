La primera plataforma de gestión de eventos con IA integrada que los automatiza. SaaS white-label end-to-end: creación, ventas, asistencia, pagos, equipo y un asistente IA propio (Gestbot) que ejecuta acciones reales sobre tu evento.
...
npm run install:all
Configuración
Copia .env.example a .env y completa las variables que vayas a usar.
En Supabase, aplica las migraciones del directorio db/migrations/ (o el combinado db/migrations/_all_pendientes.sql para 0020→0028).
...
🤝 Contribuir
Este es un proyecto desarrollado por Juan Medina Orjuela. Para sugerencias, abre un Issue o un PR contra main.
